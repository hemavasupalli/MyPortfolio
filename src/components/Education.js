...
const Education = () => {
  return (
    <div className='min-h-screen pt-20 pr-10 mt-20 bg-blue-100 bg-gradient-to-r from-cyan-200 to-yellow-200'>
      ...
      <div className="w-full mx-auto lg:max-w-3xl">
        <div className="w-full p-6 mt-24 mb-10 ml-5 font-bold text-black rounded-lg shadow-md hover:shadow-gray-800 h-60 bg-lime-100">
