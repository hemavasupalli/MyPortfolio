...
const AboutMe = () => {
  return (
    <div className='min-h-screen font-bold text-center pt-[20rem] bg-gradient-to-r from-cyan-200 to-yellow-200'>
  
      <h1 className='p-3 text-2xl text-center text-orange-600 lg:ml-24 lg:pb-10 lg:text-4xl animate-pulse'>Find Me On</h1>

      <ul className='flex flex-wrap  justify-center mt-5 lg:ml-[38.5rem] lg:justify-start'>
