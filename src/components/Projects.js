...
const Section = ({ img, title, github, demo, li1, li2, li3, li4 }) => {
  return (
    <div className="max-w-[40rem] mx-auto lg:mx-10 hover:shadow-gray-800 p-5 mb-10 mt-10 rounded-lg shadow-md font-bold bg-lime-100 text-black">
...
const Experience = () => {
  return (
    <>
      <div className="min-h-screen pl-5 mt-24 mb-24 bg-blue-100 bg-gradient-to-r from-cyan-200 to-yellow-200">
